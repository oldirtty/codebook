...
\lstinputlisting{base/init.sh}

\subsection{Compile script}
\lstinputlisting{base/compile.sh}
...
\lstinputlisting{estruturaDeDados/segTreeLazy.cpp}
...
\lstinputlisting{matematica/primeFactor.cpp}
...
\subsection{Função Totiente de Euler (φ)}
...
\lstinputlisting{arvore/centroidDecomposition.cpp}
